...
return [
    ...
    'adminGroupFromAD'=>'CUCMADMINGROUP', //пользователи в группе АД имеющие права админа
    'reportGroupFromAD'=>'CUCMREPORTGROUP', //пользователи в группе АД имеющие доступ на отчеты
];
